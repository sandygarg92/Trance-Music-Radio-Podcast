...
package com.onlineradiofm.trancemusicradio.ypylibs.music.control;
...
public abstract class YPYPlaybackControl {
    ...
    public YPYPlaybackControl(@NonNull Context context) {
        mApplicationContext = context.getApplicationContext();
        mAudioManager = (AudioManager) mApplicationContext.getSystemService(Context.AUDIO_SERVICE);
        mAudioFocusHelper = new AudioFocusHelper();
    }

    public abstract void playMusicModel(YPYMusicModel musicModel);

    public YPYMusicModel getCurrentMedia(){
        return mCurrentMusicModel;
    }

    public abstract boolean isPlaying();

    public final void play() {
        if (mAudioFocusHelper!=null && mAudioFocusHelper.requestAudioFocus()) {
...
//                    }
    ...
    public boolean isStartLoading() {
        return isStartLoading;
    }

    public int getColorNotification() {
        return mColorNotification;
    }

    public abstract long getDuration();
    public abstract long getCurrentPosition();

    protected abstract MediaMetadataCompat buildMetaDataCompat(Bitmap mBitmapTrack);
