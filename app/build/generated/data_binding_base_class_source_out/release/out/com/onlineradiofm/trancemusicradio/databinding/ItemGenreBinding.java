...
public final class ItemGenreBinding implements ViewBinding {
  ...
  private ItemGenreBinding(@NonNull RelativeLayout rootView, @NonNull AppCompatImageView imgGenre,
  ...
  public static ItemGenreBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemGenreBinding((RelativeLayout) rootView, imgGenre, layoutRoot, tvName);
    }
