...
public final class ItemPodcastBinding implements ViewBinding {
  ...
  private ItemPodcastBinding(@NonNull RelativeLayout rootView, @NonNull AppCompatImageView imgGenre,
  ...
  public static ItemPodcastBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPodcastBinding((RelativeLayout) rootView, imgGenre, layoutRoot, tvName);
    }
