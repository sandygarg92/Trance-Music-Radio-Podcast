...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.onlineradiofm.trancemusicradio.ypylibs.imageloader.model.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.onlineradiofm.trancemusicradio.ypylibs.imageloader.model.GlideOptions().apply(toSet));
    }
  }
}
